    ...
    return (
        <div className="container animate-scale" style={{marginTop: '4rem', maxWidth: '500px'}}>
            <div style={{textAlign: 'center', marginBottom: '3rem'}}>
                <span style={{textTransform: 'uppercase', fontWeight: 900, color: '#276EF1', letterSpacing: '2px', fontSize: '0.65rem'}}>Join ExpenseFlow</span>
            ...
            <form onSubmit={step === 1 ? handleNext : handleSubmit} className="auth-glass-card" style={{padding: '3rem'}}>
                {error && <div className="error-alert" style={{background:'#FDECEA',color:'#E53935',padding:'0.75rem 1rem',borderRadius:'10px',fontWeight:700,fontSize:'0.85rem',marginBottom:'1.5rem'}}>{error}</div>}
                {step === 1 ? (
